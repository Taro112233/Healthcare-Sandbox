...
import { User, Phone, Save, X, Loader2, CheckCircle2 } from 'lucide-react';
...
export function PersonalInfoSection({ profile, onUpdate, isUpdating }: PersonalInfoSectionProps) {
  ...
  return (
    <Card>
      ...
      <CardContent>
        {successMessage && (
          <Alert className="mb-4 bg-alert-success-bg border-alert-success-border">
            <CheckCircle2 className="h-4 w-4 text-alert-success-icon" />
